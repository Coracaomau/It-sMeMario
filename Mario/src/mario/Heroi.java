...
public class Heroi {
   ...
   public Heroi(Ponto posicaoInicial,  int velocidadeAndar, Ponto vectorGravidade, int velocidadeSalto, Nivel nivel, long tempo){
      ...
      //sprite.addSpriteColisionListener(this, "testar");
   ...
   public void testar (PlataformaFixaSimples plataforma, ResultadoColisao resultado){
	   System.out.println("TESTE1");
	   if(movimento.getUltimaPosicao().x + 20 <= plataforma.getPosicaoPlataforma().x){
		   System.out.println("TESTE2");
		   movimento = new MovimentoHeroiLivre(movimento.getUltimaPosicao(),
				vectorGravidade, velocidadeAndar, velocidadeSalto, 3);
	   		sprite.setMovimento(movimento);
	   		((MovimentoHeroiLivre) movimento).saltar();
	   }
   }
